import { Box, Button, Flex, Input, Text, ButtonGroup } from '@chakra-ui/react';
...
const home = () => (
  <Box>
    ...
    >
      ...
      <Input h="10" mb="10" variant="outline" placeholder="Title" />
      <Text>Description </Text>
      <Input h="40" mb="5" variant="outline" placeholder="Enter a description" />
      <Text>Post number</Text>
      <Input h="20" mb="10" variant="outline" placeholder="kn/76/10" />
